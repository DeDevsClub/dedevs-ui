...
const models = [
  {
    ...
    imgUrl: 'https://ui.dedevs.com/assets/logos/openai-logo.png',
  },
  {
    id: 'claude-sonnet-4',
    name: 'Claude Sonnet 4',
    provider: 'claude.ai',
    imgUrl: 'https://ui.dedevs.com/assets/logos/claude-logo.png',
  },
  {
    id: 'gemini-2.5-pro',
    name: 'Gemini 2.5 Pro',
    provider: 'anthropic.com',
    imgUrl: 'https://ui.dedevs.com/assets/logos/gemini-logo.png',
  },
];
