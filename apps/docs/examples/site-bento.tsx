 ...
 * @date: 2025-08-06
 * @license: MIT
 * @website: https://ui.dedevs.com
 * @github: https://github.com/dedevsclub/dedevs-ui
 */
...
import { type BentoItem } from "@repo/site/bento";   

const bentoItems: BentoItem[] = [
    {
        id: "main",
        title: "AI-Powered Decentralized Future",
        description:
            "Building the next generation of decentralized applications with AI intelligence at the core, creating autonomous systems that scale globally.",
        href: "#",
        feature: "spotlight",
        spotlightItems: [
    ...
    },
    {
        ...
        description:
            "Smart contracts that learn and adapt using on-chain AI models",
        href: "#",
        feature: "typing",
        typingText:
            "// Deploy AI-powered smart contract\nconst deployAIContract = async () => {\n  const contract = new AISmartContract({\n    model: 'llama-3.1-70b',\n    chain: 'ethereum',\n    governance: 'decentralized'\n  });\n\n  // Train on blockchain data\n  await contract.trainOnChainData();\n  \n  // Deploy with governance\n  return await contract.deploy();\n};",
        size: "md",
        className: "col-span-2 row-span-1",
    },
    {
        ...
        description:
            "Revolutionary DeFi protocols powered by AI for optimal yield farming and risk management",
        href: "#",
        feature: "metrics",
        metrics: [
            { label: "TVL Growth", value: 95, suffix: "%", color: "emerald" },
            { label: "AI Accuracy", value: 98, suffix: "%", color: "blue" },
            { label: "Gas Optimization", value: 87, suffix: "%", color: "violet" },
        ],
        size: "md",
    ...
    },
    {
        ...
        description:
            "The convergence of AI and blockchain technology creating the next internet",
        href: "#",
        feature: "timeline",
        timeline: [
            { year: "2020", event: "DeFi Summer & Smart Contracts" },
            { year: "2021", event: "NFTs & Digital Ownership" },
            { year: "2022", event: "AI Integration & ML Models" },
            { year: "2023", event: "Decentralized AI Networks" },
            { year: "2024", event: "Autonomous Web3 Ecosystems" },
        ],
        size: "sm",
        className: "col-span-1 row-span-1",
    },
...
export default function BentoGrid() {
    return (
        <section className="relative py-2 bg-white dark:bg-black overflow-auto">
