...
export default function SiteFeaturesExample() {
  return (
    <div className="flex flex-col w-full space-y-12 bg-background">
      {/* Grid Layout Example */}
      <div>
        <h2 className="text-2xl font-bold mb-6 bg-background">Grid Layout (3 columns)</h2>
        <Features
      ...
      <div className="bg-background">
        <h2 className="text-2xl font-bold mb-6 bg-background">List Layout</h2>
        <Features
      ...
      <div className="bg-background">
        <h2 className="text-2xl font-bold mb-6 bg-background">Alternating Layout</h2>
        <Features
      ...
      {/* 4 Column Grid */}
      <div className="bg-background">
        <h2 className="text-2xl font-bold mb-6 bg-background">4 Column Grid</h2>
        <Features
      ...
      {/* 2 Column Grid */}
      <div className="bg-background">
        <h2 className="text-2xl font-bold mb-6 bg-background">2 Column Grid</h2>
        <Features
          features={sampleFeatures.slice(0, 4)}
          title="Key Benefits"
