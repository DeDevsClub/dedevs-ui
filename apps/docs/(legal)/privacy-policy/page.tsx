...
export const metadata: Metadata = {
    title: "Privacy Policy | DeDevs",
    description: "Privacy Policy for DeDevs.",
};
...
export default function PrivacyPolicyPage() {
    return (
        <div className="container mx-auto px-4 py-12 md:px-6 md:py-20 lg:max-w-4xl">
            ...
            <p className="text-muted-foreground mb-8 text-sm">Last Updated: 5 Aug 2025</p>
            ...
            <section className="mb-8 space-y-4">
                ...
                <p className="text-muted-foreground">
                    ...
                    <a href="mailto:buns@dedevs.club" className="text-primary hover:underline">
                        buns@dedevs.club
                    </a>
                </p>
            </section>
