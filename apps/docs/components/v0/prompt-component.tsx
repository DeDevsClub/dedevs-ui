...
export default function PromptComponent({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const userApiKey =
                typeof window !== "undefined" ? (await import("../../lib/api-key-storage")).default.getApiKey() : null
    ...
    return (
        <>
                                    ...
                                    <div className="relative">
                                        ...
                                        {speechSupported && (
                                            <button
                                                ...
                                                disabled={isLoading}
                                                className={`absolute top-1/2 -translate-y-1/2 flex items-center justify-center h-8 w-8 sm:h-10 sm:w-10 rounded-lg transition-all duration-200 cursor-pointer disabled:cursor-not-allowed ${isListening
            ...
            {/* Image Preview */}
            <ImagePreview
                src={previewState.src || "/placeholder.svg"}
