...
<PoweredBy packages={[
  { name: 'lucide-react', url: 'https://lucide.dev/', icon: 'simple-icons:lucide' },
  { name: '@radix-ui/react-collapsible', url: 'https://www.radix-ui.com/docs/primitives/components/collapsible', icon: 'simple-icons:radixui' },
]} />
...
<Installer packageName="ai-reasoning" />
