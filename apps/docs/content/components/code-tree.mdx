...
import { Folder, File, FolderOpen, Image, Video, Music, Settings, Users, Database, FileText } from "lucide-react";

<Preview path="code-tree" type="component" />
...
```bash
pnpm add @radix-ui/react-slot class-variance-authority framer-motion lucide-react
```
...
<Tabs items={["Preview", "Code"]}>
  <Tab value="Preview">
    <ComponentPreview name="code-tree" />
  </Tab>
  <Tab value="Code">
    ```tsx
...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx
    import { Video, Music, Folder } from "lucide-react";
...
<TypeTable
  type={{
    ...
    isLast: {
      description: "Whether this item is the last among its siblings (used for line rendering)",
      type: "boolean",
      default: "false",
    },
    parentPath: {
      description: "Boolean array describing whether each ancestor was last among its siblings (used for drawing connector lines)",
      type: "boolean[]",
      default: "[]",
    },
  }}
