---
title: MCP Server
description: DeDevs UI Design Registry supports the Model Context Protocol (MCP) for AI-powered chatbot development.
---
...
DeDevs UI Design Registry supports MCP to supercharge your AI chatbot development workflow, giving your AI assistant detailed knowledge about our specialized chatbot interface components.
