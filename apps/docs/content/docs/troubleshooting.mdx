...
description: Solutions for common issues with the DeDevs UI Design Registry for AI chatbot interfaces.
---
...
If none of these answers help, open an [issue on GitHub](https://github.com/DeDevsClub/dedevs-ui/issues) and someone from the DeDevs team will be happy to assist. Please include:
