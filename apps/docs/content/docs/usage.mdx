---
title: Usage
description: Learn how to use DeDevs UI components in your application.
---

Once a DeDevs UI component is installed, you can import it and use it in your application like any other React component. The components are added as part of your codebase (not hidden in a library), so the usage feels very natural.

## Example

Let's say you want to create a chatbot interface using the DeDevs UI AI components. Here's how you might compose them together:
...
const ChatInterface = () => (
  <div className="flex flex-col h-[600px]">
    <AIConversation>
      ...
      <AIMessage role="user">
        <AIMessageContent>
          How can I use DeDevs UI components?
        </AIMessageContent>
      ...
      <AIMessage role="assistant">
        <AIMessageContent>
          <AIResponse>
            # DeDevs UI Components
            
            DeDevs UI provides specialized components for AI interfaces. Here's how to use them:
...
All DeDevs UI components take as many primitive attributes as possible. For example, the `AIResponse` component extends `HTMLAttributes<HTMLDivElement>`, so you can pass any props that a `div` supports. This makes it easy to extend the component with your own styles or functionality.
